...
//				Log.d("CYCBike","mMenuRightPadding-------------"+mMenuRightPadding);
                    break;
            }
        }
        a.recycle();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.d("CYCBike", "mThirdMenuWidth--------------------" + mThirdMenuWidth);
                Log.d("CYCBike", "scrollX--------------------" + scrollX);
                if (!isOpen) {
...
//					return false;
//				}
//				Log.d("CYCBike","curX------------"+curX);
//				Log.d("CYCBike","curY------------"+curY);
//				Log.d("CYCBike","isOpen------------"+isOpen);
                if (curY > 0 && curY < 500) {
                    return false;
                }
...
//		Log.d("CYCBike","mMenuWidth----------------"+mMenuWidth);
//		Log.d("CYCBike","l---------------"+l);
//		Log.d("CYCBike","scale----------------"+l * 1.0f / mMenuWidth);
//		Log.d("CYCBike"," mMenuWidth * scale * 0.7f----------------"+ mMenuWidth * scale * 0.7f);
