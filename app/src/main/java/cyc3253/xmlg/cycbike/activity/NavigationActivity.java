...
import cyc3253.xmlg.cycbike.adapter.PoiHostoryAdapter;
import cyc3253.xmlg.cycbike.adapter.PoiSuggestionAdapter;
import cyc3253.xmlg.cycbike.adapter.RecyclerViewDivider;
import cyc3253.xmlg.cycbike.provider.PoiObject;
import cyc3253.xmlg.cycbike.provider.ProviderUtil;
import cyc3253.xmlg.cycbike.tools.LocationManager;
import cyc3253.xmlg.cycbike.utils.NavigatorUtil;
import cyc3253.xmlg.cycbike.utils.Utils;

import static cyc3253.xmlg.cycbike.utils.NavigatorUtil.activityList;

/**
 * 导航  输入起点终点.
 */

public class NavigationActivity extends BaseActivity implements OnGetSuggestionResultListener,
        PoiSuggestionAdapter.OnItemClickListener, PoiHostoryAdapter.OnHistoryItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //想使用内置导航，必须初始化导航， NavigatorUtil.initNavi(this);
        NavigatorUtil.initNavi(this);
        ...
        recyclerview_poi.addItemDecoration(new RecyclerViewDivider(this, LinearLayoutManager.HORIZONTAL,
                1, ContextCompat.getColor(this, R.color.color_c8cacc)));
        ...
        recyclerview_poi_history.addItemDecoration(new RecyclerViewDivider(this, LinearLayoutManager.HORIZONTAL,
                1, ContextCompat.getColor(this, R.color.color_c8cacc)));
    ...
    public void backFromSearchPlace(View view) {
        ...
        place_edit.setText("");
        if (sugAdapter != null) sugAdapter.changeData(null);
    ...
    public void startNavigation(View view) {
        ...
        if (startLL != null && endLL != null) {
            ...
            NavigatorUtil.showChoiceNaviWayDialog(this, startLL, endLL, start, end);
        }
    }
