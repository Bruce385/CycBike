package cyc3253.xmlg.cycbike.service;
...
import cyc3253.xmlg.cycbike.bean.RoutePoint;
...
//        mBaiduMap.setMyLocationEnabled(true);
    ...
    public void onDestroy() {
        ...
        if (routPointList.size() > 2) insertData(routeListStr);
    ...
    public class MylocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation bdLocation) {
            ...
            if (routPointList.size() == 0) routPointList.add(routePoint);
            else {
...
//                        Log.d("RouteService", "distantce--------------" + distantce);
                        if (distantce > 5) {
...
//            Log.d("RouteService", "biginTime--------------" + beginTime);
            Log.d("RouteService", "totalTime--------------" + totalTime);
            Log.d("RouteService", "totalDistance--------------" + totalDistance);
