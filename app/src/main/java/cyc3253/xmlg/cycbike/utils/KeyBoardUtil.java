...
public class KeyBoardUtil {
    ...
    public static void setOnKeyBoardChangeListener(Activity activity, OnKeyBoardChangeListener onKeyBoardChangeListener) {
        KeyBoardUtil keyBoardListener = new KeyBoardUtil(activity);
